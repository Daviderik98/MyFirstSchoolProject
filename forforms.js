...
function fourthClickOne(){
    document.getElementById('4thans1').innerHTML = "Correct. This was the year I started editing an got a taste for it."
}
...
if (j == 0){
    alert("You have filled in everything. The test is now over!");
}
else{
    alert("Everything has to be filled in!");
}
